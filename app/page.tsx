    ...
    return (
        <div className="relative group">
          ...
          {formatName(user.name)}
            ...
            <div
                className="absolute right-0 mt-1 w-36 py-1 bg-white rounded-lg shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                <Link
                    href={`/users/${user.id}`}
